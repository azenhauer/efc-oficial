...
function NavBar() {
    ...
    return (
        <div id="bar" className="sticky-navbar flex w-full justify-center  flex-wrap">
            ...
            <nav id="nav" className="flex w-full justify-center mb-4">
                ...
                <ul className="main-bar">
                    ...
                    <li className="nav-list"><NavLink to="/apresentacoes">APRESENTAÇÕES</NavLink></li>
                </ul>
                ...
                <ul className={`sidebar ${isSidebarOpen ? 'sidebar--open' : ''}`}>
                    ...
                    <li><NavLink to="/apresentacoes">APRESENTAÇÕES</NavLink></li>
                </ul>
            </nav>
        </div>
    );
